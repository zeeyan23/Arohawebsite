                ...
                <Col className={classes.colStyleArticle}>
                    <Container className={classes.cont}>
                        <Col className="tabletColo">
                            ...
                            <Row className="pt-3" id={classes.dividerCont}><hr className={classes.divider}/></Row>
                            <Row id={classes.rowStyle}><a className={classes.mailTextColor} id='link1'  href="https://arohagroup.com/tips-to-make-a-high-quality-website-development/" target='_blank'><FontAwesomeIcon className={classes.arrowMark} icon={faLongArrowRight} />Website developer in india</a></Row>
                            <Row id={classes.rowStyle}><a className={classes.mailTextColor} href="https://arohagroup.com/graphic-design-in-udupi-manipal/" target='_blank'><FontAwesomeIcon className={classes.arrowMark} icon={faLongArrowRight} />Magazine Designing Steps</a></Row>
                            <Row className={classes.links} id={classes.rowStyle}><a className={classes.mailTextColor} href="https://arohagroup.com/why-social-media-is-important-to-your-business/" target='_blank'><FontAwesomeIcon className={classes.arrowMark} icon={faLongArrowRight} />Why social media is important?</a></Row>
                            <Row className={classes.links} id={classes.rowStyle}><a className={classes.mailTextColor} href="https://arohagroup.com/portfolio-website-developers-in-udupi-mangalore/" target='_blank'><FontAwesomeIcon className={classes.arrowMark} icon={faLongArrowRight} />Portfolio Website Importtance</a></Row>
                            <Row className={classes.links} id={classes.rowStyle}><a className={classes.mailTextColor} href="https://arohagroup.com/wordpress-website-development-in-udupi/" target='_blank'><FontAwesomeIcon className={classes.arrowMark} icon={faLongArrowRight} />WordPress Website Development</a></Row>
                        </Col>
                    </Container>
                </Col>
